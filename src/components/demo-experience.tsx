      ...
      <section className="section-grid" id="architecture">
        ...
        <div className="architecture-grid">
          ...
          <article className="section-card">
            ...
            <ul className="section-list">
              <li>
                Hard-limit placeholders exist for file count, file size,
                extracted text, and total workflow text.
              </li>
              <li>One generated brief per run.</li>
              <li>
                At most one follow-up question, and it must be about the
                generated brief.
              </li>
              <li>
                The full brief workflow is still intentionally bounded and not
                faked in the UI.
              </li>
              <li>
      ...
      <section className="section-grid" id="features">
        <div className="section-heading">
          ...
          <p className="lede lede--compact">
            ...
            some are explicitly deferred, and some are blocked out on purpose to
            keep phase 1 small and real.
          </p>
        </div>
